...
Documentos de apoio da fase atual:

- [Inventário das peças estruturais e uniões](18_inventario_unioes_estruturais.md)
  — passo 1 da generalização das uniões (mapa + tabela de decisão).
