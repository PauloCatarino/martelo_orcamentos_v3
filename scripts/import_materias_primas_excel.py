...
COLUMN_ALIASES = {
    ...
    # CORESP_ORLA_0_4 / CORESP_ORLA_1_0 (also accept the short CORESP_ORLA_0 / _1).
    "coresp_orla_0_4": ("coresporla04", "coresporla0"),
    "coresp_orla_1_0": ("coresporla10", "coresporla1"),
    "unidade": ("und", "unidade", "un"),
    "preco_tabela": ("precotabela", "preco"),
    "desconto": ("desc2", "desconto", "desc"),
    "margem": ("mrg", "margem"),
    "desperdicio_percentagem": ("desp", "desperdicio", "desperdiciopercentagem"),
...
def extract_row(row: tuple, column_map: dict) -> dict:
    ...
    return {
        ...
        "coresp_orla_0_4": to_text(cell("coresp_orla_0_4")),
        "coresp_orla_1_0": to_text(cell("coresp_orla_1_0")),
        ...
        "desperdicio_percentagem": to_decimal(cell("desperdicio_percentagem")),
