...
DEFAULT_SYSTEM_SETTINGS: tuple[SystemSettingSeed, ...] = (
    ...
    SystemSettingSeed(
        ...
        "Fornecedor de visão para roupeiros (openai / local)",
        "texto",
        "IA Roupeiros",
        "openai",
    ),
    SystemSettingSeed(
        ...
        "Modelo OpenAI de visão para roupeiros",
        "texto",
        "IA Roupeiros",
        "gpt-5.2",
    ),
    SystemSettingSeed(
        ...
        "Modelo local de visão para roupeiros (Ollama)",
        "texto",
        "IA Roupeiros",
        "",
    ),
    SystemSettingSeed(
        ...
        "Endpoint local de visão para roupeiros",
        "texto",
        "IA Roupeiros",
