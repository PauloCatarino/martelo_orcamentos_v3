...
class OrcamentoItemValuesetLinhaDialog(QDialog):
    ...
    def __init__(
        self,
        linha: OrcamentoItemValuesetLinhaResumo | None = None,
        parent=None,
        on_save: Callable[[OrcamentoItemValuesetLinhaDialogData], bool] | None = None,
        on_save_as: Callable[[OrcamentoItemValuesetLinhaDialogData], bool] | None = None,
    ) -> None:
        ...
        self.setWindowTitle(
            "Editar Linha ValueSet do Item"
            if self._is_edit
            else "Nova Linha ValueSet do Item"
        )
        self.setModal(True)
    ...
    def _validate_and_run(
        self,
        callback: Callable[[OrcamentoItemValuesetLinhaDialogData], bool] | None,
        *,
